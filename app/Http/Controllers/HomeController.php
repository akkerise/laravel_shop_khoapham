...
class NL_Checkout
{
    ...
    public $merchant_site_code = '45320'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn
    // Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
    public $secure_pass= 'quintus49K'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
